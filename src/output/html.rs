...
pub fn render_html_document(
    ...
    let workspace_meta = workspace_navigation
        .map(|navigation| {
            format!(
                concat!(
                    "  <meta name=\"AgentExport:workspace-shell-href\" content=\"{shell}\">\n",
                    "  <meta name=\"AgentExport:workspace-reports-shell-href\" content=\"{reports}\">\n",
                    "  <meta name=\"AgentExport:workspace-integration-shell-href\" content=\"{integration}\">\n"
                ),
    ...
    format!(
        concat!(
            ...
            "  <title>{title}</title>\n",
            "  <meta name=\"AgentExport:archive-title\" content=\"{archive_title_meta}\">\n",
            "  <meta name=\"AgentExport:thread-display-name\" content=\"{thread_display_name_meta}\">\n",
            "  <meta name=\"AgentExport:connector\" content=\"{connector_meta}\">\n",
            "  <meta name=\"AgentExport:thread-id\" content=\"{thread_id_meta}\">\n",
            "  <meta name=\"AgentExport:exported-at\" content=\"{exported_at_meta}\">\n",
            "  <meta name=\"AgentExport:completeness\" content=\"{completeness_meta}\">\n",
            "  <meta name=\"AgentExport:source-kind\" content=\"{source_kind_meta}\">\n",
            "{workspace_meta}",
            "  <style>\n{style}\n  </style>\n",
            "</head>\n",
            "<body>\n",
            ...
            "      <p class=\"eyebrow\">AgentExport transcript export</p>\n",
            "      <h1>{title_html}</h1>\n",
...
mod tests {
    ...
    fn render_html_document_wraps_transcript_in_single_page() {
        ...
        assert!(document.contains("AgentExport 对话归档"));
        assert!(document.contains("AgentExport:archive-title"));
    ...
    fn render_html_document_inserts_preview_when_no_user_message_exists() {
        ...
        let document =
            render_html_document(&transcript, "AgentExport", "2026-04-05T00:00:00Z", None);
    ...
    fn render_html_document_can_embed_workspace_navigation() {
        ...
        assert!(document.contains("AgentExport:workspace-shell-href"));
        assert!(document.contains("AgentExport:workspace-reports-shell-href"));
        assert!(document.contains("AgentExport:workspace-integration-shell-href"));
