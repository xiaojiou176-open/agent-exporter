...
pub fn render_integration_report_document(report: &IntegrationReportDocument) -> String {
    ...
    format!(
        concat!(
            ...
            "  <title>{title}</title>\n",
            "  <meta name=\"AgentExport:report-title\" content=\"{title}\">\n",
            "  <meta name=\"AgentExport:report-kind\" content=\"{kind}\">\n",
            "  <meta name=\"AgentExport:integration-platform\" content=\"{platform}\">\n",
            "  <meta name=\"AgentExport:integration-readiness\" content=\"{readiness}\">\n",
            "  <meta name=\"AgentExport:integration-target\" content=\"{target_root}\">\n",
            "  <meta name=\"AgentExport:generated-at\" content=\"{generated_at}\">\n",
            "  <style>\n{style}\n  </style>\n",
            "</head>\n",
            "<body>\n",
            "  <main class=\"page-shell\">\n",
            "    <header class=\"hero-card\">\n",
            "      <p class=\"eyebrow\">AgentExport integration evidence</p>\n",
            "      <h1>{title}</h1>\n",
...
mod tests {
    ...
    fn render_integration_report_document_includes_meta_tags() {
        let html = render_integration_report_document(&IntegrationReportDocument {
            ...
            launcher_command: "/tmp/AgentExport".to_string(),
        ...
        assert!(html.contains("AgentExport:report-kind\" content=\"doctor"));
        assert!(html.contains("AgentExport:integration-platform\" content=\"codex"));
        assert!(html.contains("AgentExport:integration-readiness\" content=\"ready"));
        assert!(html.contains("AgentExport:integration-target\" content=\"/tmp/codex-pack"));
