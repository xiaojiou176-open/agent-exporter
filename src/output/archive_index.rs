...
pub fn render_archive_index_document(
    ...
    let body = if entries.is_empty() {
        "<section class=\"empty-state\"><h2>还没有 HTML transcript exports</h2><p>先运行 `AgentExport export ... --format html`，再回来生成 archive index。</p></section>".to_string()
    } else {
        entries
            .iter()
            .map(render_entry)
                    ...
                    .map(|summary| {
                        format!(
                            concat!(
                                ...
                                "<p class=\"mono-inline\">Pin as official answer: <code>AgentExport publish pin-answer --workspace-root &lt;repo&gt; --artifact ./{json_href} --label &quot;{label}&quot;</code></p>",
                                "</section>"
                            ),
            ...
            .map(|pin| {
                ...
                format!(
                    concat!(
                        ...
                        "<p class=\"mono-inline\">Resolve via CLI: <code>AgentExport publish resolve-answer --workspace-root &lt;repo&gt; --label &quot;{label}&quot;</code></p>",
                        "<p class=\"mono-inline\">Unpin via CLI: <code>AgentExport publish unpin-answer --workspace-root &lt;repo&gt; --label &quot;{label}&quot;</code></p>",
                        "<p class=\"mono-inline\">Supersede via CLI: <code>AgentExport publish pin-answer --workspace-root &lt;repo&gt; --artifact ./{artifact_json} --label &quot;next-{label}&quot; --supersedes &quot;{label}&quot;</code></p>",
                        "</article>"
                    ),
