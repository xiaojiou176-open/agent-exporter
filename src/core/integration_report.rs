...
pub fn build_integration_evidence_explain(
    ...
    let failing_checks = checks
        ...
        .collect::<Vec<_>>();
    let recheck = format!(
        "Rerun `AgentExport doctor integrations --platform {platform} --target {target}` and, if needed, save a fresh report before comparing again."
    );
...
fn default_step_for_check(label: &str) -> String {
    match label {
        ...
        "bridge_script" => "Restore `scripts/agent-export_mcp.py` in this repo.".to_string(),
    ...
    fn collect_integration_report_entries_reads_report_meta_tags() {
        ...
        std::fs::write(
            ...
            concat!(
                ...
                "<meta name=\"AgentExport:report-title\" content=\"Codex doctor report\">",
                "<meta name=\"AgentExport:report-kind\" content=\"doctor\">",
                "<meta name=\"AgentExport:integration-platform\" content=\"codex\">",
                "<meta name=\"AgentExport:integration-readiness\" content=\"ready\">",
                "<meta name=\"AgentExport:integration-target\" content=\"/tmp/codex-pack\">",
                "<meta name=\"AgentExport:generated-at\" content=\"2026-04-06T12:00:00Z\">",
                "</head><body></body></html>"
            ),
        )
        .expect("write report");
