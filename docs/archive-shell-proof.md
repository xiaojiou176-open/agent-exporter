...
description: What the archive shell proves, what it does not prove, and how to reproduce it locally with AgentExport.
---
...
<section class="ae-hero">
  <div class="ae-hero-main">
    ...
    <div class="ae-actions">
      <a class="ae-button ae-button-primary" href="https://github.com/xiaojiou176-open/agent-export">Back to GitHub front door</a>
...
<section class="ae-section">
  ...
  <div class="ae-media-grid">
    <figure class="ae-media-card">
      <img src="./assets/archive-shell-proof.svg" alt="AgentExport archive shell proof diagram">
    ...
    <figure class="ae-media-card">
      <img src="./assets/proof-ladder.svg" alt="AgentExport proof ladder from CLI to transcript receipt to archive shell">
...
<section class="ae-section">
  ...
  <div class="ae-proof-grid">
    ...
    <article class="ae-proof-card">
      ...
      <div class="ae-inline-links">
        <a class="ae-button" href="https://github.com/xiaojiou176-open/agent-export/blob/main/llms-install.md">Open install note on GitHub</a>
        <a class="ae-button" href="https://github.com/xiaojiou176-open/agent-export/blob/main/server.json">Open server.json on GitHub</a>
      </div>
    </article>
    <article class="ae-proof-card">
...
<section class="ae-section">
  <div class="ae-note-grid">
    ...
    <article class="ae-note-card">
      ...
      <p><code>AgentExport</code> is already more than an export utility, but its first public proof still has to start with CLI quickstart, transcript export, and archive shell generation.</p>
    </article>
  </div>
</section>
