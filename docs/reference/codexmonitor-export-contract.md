...
> 如果 `AgentExport` 要从 CodexMonitor 当前能力里“继承导出语义”，那我们到底必须继承什么？
...
## 当前 `AgentExport` dual-source 落地状态
...
> `AgentExport` 现在不是“只有正门”，而是“正门 + 侧门都已经装好”。
