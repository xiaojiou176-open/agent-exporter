  ...
  <div class="ae-hero-side ae-panel">
    ...
    <dl class="ae-glance-list">
      ...
      <div>
        ...
        <dd><code>v0.1.10</code> is the newest frozen packet</dd>
      </div>
      <div>
...
<section class="ae-section">
  ...
  <div class="ae-proof-grid">
    ...
    <article class="ae-proof-card">
      ...
      <p><code>v0.1.10</code> is the newest published shelf. It should match the current packet truth for this cut, even if later work moves ahead again on <code>main</code>.</p>
    </article>
    <article class="ae-proof-card">
...
> On `2026-04-22`, repo-owned local smoke, public-surface contract tests, cockpit truth-sync checks, live public URL rereads, and release-facing packet/version readbacks all ran again.
...
| ClawHub status | `2026-04-22` | packet-manifest readback remains aligned after the `v0.1.10` shelf refresh | external platform outcome after repo packet |
| Goose / agent-skill.co / OpenHands / Smithery / awesome-opencode | `2026-04-22` | prior external lane verdicts still stand; this cut only refreshes the repo-owned published shelf and packet contract | platform / reviewer later |
