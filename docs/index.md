...
<section class="ae-hero">
  <div class="ae-hero-main">
    ...
    <p class="ae-lead">
      <code>AgentExport</code> keeps the front door honest:
...
<section class="ae-section">
  ...
  <figure class="ae-media-card">
    <a href="./promo-reel.html">
      <img src="./assets/media/AgentExport-promo-poster.png" alt="Poster frame from the AgentExport promo reel">
    </a>
  ...
  <div class="ae-proof-grid">
    <article class="ae-proof-card">
      ...
      <h3>Social card</h3>
      <p>Need a single-frame preview for a post, chat share, or reviewer packet? Use the <a href="./assets/media/AgentExport-social-card.png">social card image</a>.</p>
    </article>
    <article class="ae-proof-card">
